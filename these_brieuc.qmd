...
```{r}
#| label: fig-level-performance-stacked
#| echo: false
#| fig-cap: "Répartition VP, FP, FN, VN par test et par niveau"
#| fig-width: 10
#| fig-height: 10
...
ggplot(level_test_perf, aes(x = Test, y = Effectif, fill = Cellule)) +
    geom_col(position = "stack", width = 0.7, color = "white", linewidth = 0.2) +
    facet_wrap(~Niveau, ncol = 2) +
    scale_fill_manual(
        values = c(VP = nord("aurora")[4], FN = nord("aurora")[1], FP = nord("aurora")[2], VN = nord("frost")[4]),
    ...
    labs(title = "Performance des 4 tests ULNT par niveau",
